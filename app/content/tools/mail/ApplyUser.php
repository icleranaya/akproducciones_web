                                ...
                                <table style="<?= $body; ?>">
                                    <tbody>
                                        <tr style="padding:0; text-align:center; vertical-align:top;">
                                            <th style="<?= $content; ?>">
                                                <p><?= __( "¡Buenas noticias!", "onepage-theme" ); ?></p>
                                                <p style="font-size:18px;font-weight: 400;"><?= __( "Has recibido una nueva solicitud de inscripción para uno de tus cursos.", "onepage-theme" ) ?></p>
