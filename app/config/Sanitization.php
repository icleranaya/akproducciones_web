 ...
 * @returns array $output
 */
function of_sanitize_onepage( $input ) {
if ( is_array( $input ) ) {
	foreach( $input as $key => $value ) {
...
add_filter( 'of_sanitize_onepage', 'of_sanitize_onepage' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'onepage-theme' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'onepage-theme' ),
		'repeat-y'  => __( 'Repeat Vertically', 'onepage-theme' ),
		'repeat'    => __( 'Repeat All', 'onepage-theme' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'onepage-theme' ),
		'top center'    => __( 'Top Center', 'onepage-theme' ),
		'top right'     => __( 'Top Right', 'onepage-theme' ),
		'center left'   => __( 'Middle Left', 'onepage-theme' ),
		'center center' => __( 'Middle Center', 'onepage-theme' ),
		'center right'  => __( 'Middle Right', 'onepage-theme' ),
		'bottom left'   => __( 'Bottom Left', 'onepage-theme' ),
		'bottom center' => __( 'Bottom Center', 'onepage-theme' ),
		'bottom right'  => __( 'Bottom Right', 'onepage-theme' )
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'onepage-theme' ),
		'fixed'  => __( 'Fixed in Place', 'onepage-theme' )
		);
...
function of_recognized_background_size() {
	$default = array(
		'auto' => __( 'Auto', 'onepage-theme' ),
		'cover'  => __( 'Cover', 'onepage-theme' ),
		'contain'  => __( 'Contain', 'onepage-theme' )
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'onepage-theme' ),
		'italic'      => __( 'Italic', 'onepage-theme' ),
		'bold'        => __( 'Bold', 'onepage-theme' ),
		'bold italic' => __( 'Bold Italic', 'onepage-theme' )
		);
